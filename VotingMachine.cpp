	...
	while (administratorchoice!=6) {
		...
		case 4:
			...
			if (ch == 1) {
				...
				cin >> age;
				cout<<"Total Votes casted Of the "<< age<<" are " <<v1->TotalVotersRecord_ageWise(age);
			}
			else if (ch == 2) {
...
int FrontPage() {
	...
	cout << "*****************************************************************************\n";
	cout << "****************************************************************************\n";
	cout << "\n\n_____________________Created BY_________________________________\n\n";
	cout << "\t\t Ayesha Abdul Rahman\n";
